...
namespace JobSystem.DataModel.Entities
{
    ...
    public class OrderItem
    {
        ...
        [StringLength(255, ErrorMessageResourceName = "InvalidDescription",
            ErrorMessageResourceType = typeof (OrderItemMessages))]
        public virtual string Description { get; set; }

        public virtual int Quantity { get; set; }

        [StringLength(50, ErrorMessageResourceName = "InvalidPartNo",
            ErrorMessageResourceType = typeof (OrderItemMessages))]
        public virtual string PartNo { get; set; }

        [StringLength(2000, ErrorMessageResourceName = "InvalidInstructions",
            ErrorMessageResourceType = typeof (OrderItemMessages))]
